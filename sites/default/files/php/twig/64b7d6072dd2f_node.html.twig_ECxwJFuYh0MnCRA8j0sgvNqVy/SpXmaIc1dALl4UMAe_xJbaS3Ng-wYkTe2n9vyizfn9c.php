...
/* themes/solar_theme/templates/content/node.html.twig */
class __TwigTemplate_bd354ca0c1b25f3a5ccbbb5a365178f8 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 77, $this->source)))) : (""))];
        // line 80
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("solar_theme/node"), "html", null, true);
        echo "
<article";
        // line 81
...
";
    ...
    {
        return "themes/solar_theme/templates/content/node.html.twig";
    }
    ...
    {
        return new Source("", "themes/solar_theme/templates/content/node.html.twig", "C:\\MAMP\\htdocs\\alserda\\themes\\solar_theme\\templates\\content\\node.html.twig");
    }
